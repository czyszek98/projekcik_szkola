...
--
-- Host: 127.0.0.1
-- Czas generowania: 27 Wrz 2017, 23:21
...
INSERT INTO `lessons` (`id`, `name`, `background`, `subjectId`, `content`) VALUES
(1, 'Dodawanie', '#FF33AA', 1, '{\"tagName\":[\"H1\",\"p\",\"h3\",\"p\"],\"innerHtml\":[\"Dodawanie\",\"A bla bla tur tur tur lorem ipsum et at attiny2313AU\",\"Dobre fajne\",\"No no no bkle ble tekst lorem przykladowy ipsum teaki troche asdasd asd asd\"]}');
...
(15, 'Szklana gÃ³ra', '#0000ff', '#ff0000', '#00ffff');
...
(1, 4, 'andre1', 'andrzej99', 'andrzejek@gmail.com', 'S'),
...
(16, 0, 'admin', 'admin1', 'admin@a.dmin', 'A');
