...
<body>
	<div id="content">
		...
		<div id="up">	
			<div id="logo"> <a href="index.html"> <img src="http://morethangamers.com/landingpage2/img/companies/growup.png"  height="250px" width="auto"/> </a></div>
		</div>
		...
		<div id="footer">
					...
					<div id="back-footer" class="back-footer-left">Powrót do głównej strony: </div>
					<div  id="back-footer" class="back-footer-right"><a href="index.html"><img src="https://www.materialui.co/materialIcons/navigation/arrow_back_white_192x192.png" width="auto" height="75px" /></a></div>
